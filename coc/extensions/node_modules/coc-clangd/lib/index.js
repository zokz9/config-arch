...
var require_utils = __commonJS({
  "node_modules/adm-zip/util/utils.js"(exports2, module2) {
    ...
    var is_Obj = /* @__PURE__ */ __name((obj) => obj && typeof obj === "object", "is_Obj");
    ...
    Utils.toBuffer = /* @__PURE__ */ __name(function toBuffer(input) {
  ...
  "node_modules/adm-zip/headers/entryHeader.js"(exports2, module2) {
    ...
    module2.exports = function() {
      ...
      return {
        ...
        loadDataHeaderFromBinary: /* @__PURE__ */ __name(function(input) {
        ...
        dataHeaderToBinary: /* @__PURE__ */ __name(function() {
        ...
        entryHeaderToBinary: /* @__PURE__ */ __name(function() {
  ...
  "node_modules/adm-zip/zipEntry.js"(exports2, module2) {
    ...
    module2.exports = function(input) {
      ...
      return {
        ...
        packHeader: /* @__PURE__ */ __name(function() {
...
var require_zipFile = __commonJS({
  "node_modules/adm-zip/zipFile.js"(exports2, module2) {
    ...
    module2.exports = function(inBuffer, options) {
      ...
      __name(iterateEntries, "iterateEntries");
      ...
      return {
         ...
         * @return Array
         */
        getEntryChildren: /* @__PURE__ */ __name(function(entry) {
          if (!loadedEntries) {
            readEntries();
          }
          if (entry && entry.isDirectory) {
...
var require_adm_zip = __commonJS({
  "node_modules/adm-zip/adm-zip.js"(exports2, module2) {
    ...
    var get_Bool = /* @__PURE__ */ __name((val, def) => typeof val === "boolean" ? val : def, "get_Bool");
    var get_Str = /* @__PURE__ */ __name((val, def) => typeof val === "string" ? val : def, "get_Str");
    var defaultOptions = {
    ...
    module2.exports = function(input, options) {
      ...
      return {
         ...
         * @param entry
         */
        deleteFile: /* @__PURE__ */ __name(function(entry) {
          var item = getEntry(entry);
          if (item) {
         ...
         */
        addLocalFolder: /* @__PURE__ */ __name(function(localPath, zipPath, filter, attr) {
         ...
         * @return Array
         */
        getEntries: /* @__PURE__ */ __name(function() {
        ...
        extractAllToAsync: /* @__PURE__ */ __name(function(targetPath, overwrite, keepOriginalPermission, callback) {
          ...
          keepOriginalPermission = get_Bool(keepOriginalPermission, false);
          if (!callback) {
            callback = /* @__PURE__ */ __name(function(err) {
              throw new Error(err);
            }, "callback");
          }
          if (!_zip) {
          ...
          const getPath = /* @__PURE__ */ __name((entry) => sanitize(targetPath, pth.normalize(canonical(entry.entryName.toString()))), "getPath");
...
var init_lib = __esm({
  "node_modules/node-fetch/lib/index.mjs"() {
    ...
    isDomainOrSubdomain = /* @__PURE__ */ __name(function isDomainOrSubdomain2(destination, original) {
    ...
    var ReaddirpStream = class _ReaddirpStream extends Readable2 {
      ...
      static get defaultOptions() {
        return {
          ...
          fileFilter: /* @__PURE__ */ __name((path2) => true, "fileFilter"),
          directoryFilter: /* @__PURE__ */ __name((path2) => true, "directoryFilter"),
...
var require_rimraf = __commonJS({
  "node_modules/rimraf/rimraf.js"(exports2, module2) {
    ...
    var rimraf = /* @__PURE__ */ __name((p, options, cb) => {
      ...
      const afterGlob = /* @__PURE__ */ __name((er, results2) => {
        if (er)
          return cb(er);
        n = results2.length;
        if (n === 0)
...
var require_src = __commonJS({
  "node_modules/@clangd/install/out/src/index.js"(exports2) {
    ...
    __name(installLatest2, "installLatest");
    ...
    __name(checkUpdates2, "checkUpdates");
    ...
    __name(fakeGitHubReleaseURL, "fakeGitHubReleaseURL");
    exports2.fakeGitHubReleaseURL = fakeGitHubReleaseURL;
    var lddCommand = "ldd";
    function fakeLddCommand(l) {
      lddCommand = l;
    }
    __name(fakeLddCommand, "fakeLddCommand");
    ...
    (function(Github2) {
      ...
      __name(latestRelease, "latestRelease");
      ...
      __name(chooseAsset, "chooseAsset");
    ...
    (function(Install2) {
      function install(release, asset, abort, ui) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          yield ui.slow(ui.localize("Extracting {0}", asset.name), new Promise((resolve) => {
      ...
      function download(url, dest, abort, ui) {
        return __awaiter(this, void 0, void 0, function* () {
          ...
          return ui.progress(ui.localize("Downloading {0}", path2.basename(dest)), abort, (progress) => __awaiter(this, void 0, void 0, function* () {
    ...
    (function(Version2) {
      ...
      __name(rangeGreater, "rangeGreater");
    })(Version || (Version = {}));
  }
});
...
var require_fs2 = __commonJS({
  "node_modules/fs-jetpack/lib/utils/fs.js"(exports2, module2) {
    ...
    var isCallbackMethod = /* @__PURE__ */ __name((key) => {
      return [
    ...
    var adaptMethod = /* @__PURE__ */ __name((name) => {
      const original = fs2[name];
      return promisify(original);
    }, "adaptMethod");
    var adaptAllMethods = /* @__PURE__ */ __name(() => {
      const adapted = {};
...
var require_validate = __commonJS({
  "node_modules/fs-jetpack/lib/utils/validate.js"(exports2, module2) {
    "use strict";
    var prettyPrintTypes = /* @__PURE__ */ __name((types) => {
      const addArticle = /* @__PURE__ */ __name((str) => {
    ...
    var isArrayOfNotation = /* @__PURE__ */ __name((typeDefinition) => {
      return /array of /.test(typeDefinition);
    }, "isArrayOfNotation");
    var extractTypeFromArrayOfNotation = /* @__PURE__ */ __name((typeDefinition) => {
      return typeDefinition.split(" of ")[1];
    }, "extractTypeFromArrayOfNotation");
    var isValidTypeDefinition = /* @__PURE__ */ __name((typeStr) => {
    ...
    var detectType = /* @__PURE__ */ __name((value) => {
      if (value === null) {
        return "null";
      }
    ...
    var onlyUniqueValuesInArrayFilter = /* @__PURE__ */ __name((value, index, self) => {
      return self.indexOf(value) === index;
    }, "onlyUniqueValuesInArrayFilter");
    var detectTypeDeep = /* @__PURE__ */ __name((value) => {
    ...
    var validateArray = /* @__PURE__ */ __name((argumentValue, typeToCheck) => {
    ...
    var validateArgument = /* @__PURE__ */ __name((methodName, argumentName, argumentValue, argumentMustBe) => {
    ...
    var validateOptions = /* @__PURE__ */ __name((methodName, optionsObjName, obj, allowedOptions) => {
      if (obj !== void 0) {
...
var require_remove = __commonJS({
  "node_modules/fs-jetpack/lib/remove.js"(exports2) {
    ...
    var validateInput = /* @__PURE__ */ __name((methodName, path2) => {
      const methodSignature = `${methodName}([path])`;
      validate.argument(methodSignature, "path", path2, ["string", "undefined"]);
    }, "validateInput");
    var removeSync = /* @__PURE__ */ __name((path2) => {
      fs2.rmSync(path2, {
        recursive: true,
        force: true,
        maxRetries: 3
    ...
    var removeAsync = /* @__PURE__ */ __name((path2) => {
      return fs2.rm(path2, {
        recursive: true,
        force: true,
        maxRetries: 3
...
var require_dir = __commonJS({
  "node_modules/fs-jetpack/lib/dir.js"(exports2) {
    ...
    var validateInput = /* @__PURE__ */ __name((methodName, path2, criteria) => {
    ...
    var getCriteriaDefaults = /* @__PURE__ */ __name((passedCriteria) => {
    ...
    var generatePathOccupiedByNotDirectoryError = /* @__PURE__ */ __name((path2) => {
      return new Error(
        `Path ${path2} exists but is not a directory. Halting jetpack.dir() call for safety reasons.`
      );
    }, "generatePathOccupiedByNotDirectoryError");
    var checkWhatAlreadyOccupiesPathSync = /* @__PURE__ */ __name((path2) => {
      let stat;
      try {
      ...
      return stat;
    }, "checkWhatAlreadyOccupiesPathSync");
    var createBrandNewDirectorySync = /* @__PURE__ */ __name((path2, opts) => {
      const options = opts || {};
      try {
    ...
    }, "createBrandNewDirectorySync");
    var checkExistingDirectoryFulfillsCriteriaSync = /* @__PURE__ */ __name((path2, stat, criteria) => {
      const checkMode = /* @__PURE__ */ __name(() => {
      ...
      const checkEmptiness = /* @__PURE__ */ __name(() => {
        if (criteria.empty) {
    ...
    var dirSync = /* @__PURE__ */ __name((path2, passedCriteria) => {
    ...
    var checkWhatAlreadyOccupiesPathAsync = /* @__PURE__ */ __name((path2) => {
      return new Promise((resolve, reject) => {
    ...
    }, "checkWhatAlreadyOccupiesPathAsync");
    var emptyAsync = /* @__PURE__ */ __name((path2) => {
      return new Promise((resolve, reject) => {
        fs2.readdir(path2).then((list) => {
          const doOne = /* @__PURE__ */ __name((index) => {
    ...
    var checkExistingDirectoryFulfillsCriteriaAsync = /* @__PURE__ */ __name((path2, stat, criteria) => {
      return new Promise((resolve, reject) => {
        const checkMode = /* @__PURE__ */ __name(() => {
          const mode = modeUtil.normalizeFileMode(stat.mode);
          if (criteria.mode !== void 0 && criteria.mode !== mode) {
    ...
    var createBrandNewDirectoryAsync = /* @__PURE__ */ __name((path2, opts) => {
      const options = opts || {};
      return new Promise((resolve, reject) => {
    ...
    }, "createBrandNewDirectoryAsync");
    var dirAsync = /* @__PURE__ */ __name((path2, passedCriteria) => {
      return new Promise((resolve, reject) => {
        const criteria = getCriteriaDefaults(passedCriteria);
...
var require_write = __commonJS({
  "node_modules/fs-jetpack/lib/write.js"(exports2) {
    ...
    var validate = require_validate();
    var dir = require_dir();
    var validateInput = /* @__PURE__ */ __name((methodName, path2, data, options) => {
    ...
    var newExt = ".__new__";
    var serializeToJsonMaybe = /* @__PURE__ */ __name((data, jsonIndent) => {
      ...
      return data;
    }, "serializeToJsonMaybe");
    var writeFileSync = /* @__PURE__ */ __name((path2, data, options) => {
      try {
    ...
    var writeAtomicSync = /* @__PURE__ */ __name((path2, data, options) => {
      writeFileSync(path2 + newExt, data, options);
      fs2.renameSync(path2 + newExt, path2);
    }, "writeAtomicSync");
    var writeSync = /* @__PURE__ */ __name((path2, data, options) => {
      const opts = options || {};
    ...
    var writeFileAsync = /* @__PURE__ */ __name((path2, data, options) => {
      return new Promise((resolve, reject) => {
    ...
    var writeAtomicAsync = /* @__PURE__ */ __name((path2, data, options) => {
      return new Promise((resolve, reject) => {
    ...
    var writeAsync = /* @__PURE__ */ __name((path2, data, options) => {
      const opts = options || {};
      const processedData = serializeToJsonMaybe(data, opts.jsonIndent);
...
var require_append = __commonJS({
  "node_modules/fs-jetpack/lib/append.js"(exports2) {
    ...
    var appendSync = /* @__PURE__ */ __name((path2, data, options) => {
      try {
    ...
    var appendAsync = /* @__PURE__ */ __name((path2, data, options) => {
      return new Promise((resolve, reject) => {
...
var require_file = __commonJS({
  "node_modules/fs-jetpack/lib/file.js"(exports2) {
    ...
    var generatePathOccupiedByNotFileError = /* @__PURE__ */ __name((path2) => {
      return new Error(
        `Path ${path2} exists but is not a file. Halting jetpack.file() call for safety reasons.`
      );
    }, "generatePathOccupiedByNotFileError");
    var checkWhatAlreadyOccupiesPathSync = /* @__PURE__ */ __name((path2) => {
      let stat;
      try {
        stat = fs2.statSync(path2);
    ...
    var checkExistingFileFulfillsCriteriaSync = /* @__PURE__ */ __name((path2, stat, criteria) => {
      const mode = modeUtil.normalizeFileMode(stat.mode);
      const checkContent = /* @__PURE__ */ __name(() => {
    ...
    }, "checkExistingFileFulfillsCriteriaSync");
    var createBrandNewFileSync = /* @__PURE__ */ __name((path2, criteria) => {
      let content = "";
      if (criteria.content !== void 0) {
    ...
    }, "createBrandNewFileSync");
    var fileSync = /* @__PURE__ */ __name((path2, passedCriteria) => {
      const criteria = getCriteriaDefaults(passedCriteria);
      const stat = checkWhatAlreadyOccupiesPathSync(path2);
      if (stat !== void 0) {
    ...
    var checkExistingFileFulfillsCriteriaAsync = /* @__PURE__ */ __name((path2, stat, criteria) => {
      const mode = modeUtil.normalizeFileMode(stat.mode);
      const checkContent = /* @__PURE__ */ __name(() => {
        return new Promise((resolve, reject) => {
          if (criteria.content !== void 0) {
    ...
    }, "checkExistingFileFulfillsCriteriaAsync");
    var createBrandNewFileAsync = /* @__PURE__ */ __name((path2, criteria) => {
      let content = "";
      if (criteria.content !== void 0) {
        content = criteria.content;
      }
    ...
    }, "createBrandNewFileAsync");
    var fileAsync = /* @__PURE__ */ __name((path2, passedCriteria) => {
      return new Promise((resolve, reject) => {
        const criteria = getCriteriaDefaults(passedCriteria);
        checkWhatAlreadyOccupiesPathAsync(path2).then((stat) => {
          if (stat !== void 0) {
...
var require_inspect = __commonJS({
  "node_modules/fs-jetpack/lib/inspect.js"(exports2) {
    ...
    var validateInput = /* @__PURE__ */ __name((methodName, path2, options) => {
    ...
    var createInspectObj = /* @__PURE__ */ __name((path2, options, stat) => {
      const obj = {};
    ...
    var fileChecksum = /* @__PURE__ */ __name((path2, algo) => {
      const hash = crypto.createHash(algo);
      const data = fs2.readFileSync(path2);
      hash.update(data);
      return hash.digest("hex");
    }, "fileChecksum");
    var addExtraFieldsSync = /* @__PURE__ */ __name((path2, inspectObj, options) => {
    ...
    var inspectSync = /* @__PURE__ */ __name((path2, options) => {
    ...
    var fileChecksumAsync = /* @__PURE__ */ __name((path2, algo) => {
      return new Promise((resolve, reject) => {
        const hash = crypto.createHash(algo);
    ...
    var addExtraFieldsAsync = /* @__PURE__ */ __name((path2, inspectObj, options) => {
      if (inspectObj.type === "file" && options.checksum) {
    ...
    var inspectAsync = /* @__PURE__ */ __name((path2, options) => {
      return new Promise((resolve, reject) => {
...
var require_list = __commonJS({
  "node_modules/fs-jetpack/lib/list.js"(exports2) {
    ...
    var listSync = /* @__PURE__ */ __name((path2) => {
      try {
    ...
    var listAsync = /* @__PURE__ */ __name((path2) => {
      return new Promise((resolve, reject) => {
        fs2.readdir(path2).then((list) => {
          resolve(list);
        }).catch((err) => {
...
var require_tree_walker = __commonJS({
  "node_modules/fs-jetpack/lib/utils/tree_walker.js"(exports2) {
    ...
    var fileType = /* @__PURE__ */ __name((dirent) => {
    ...
    var initialWalkSync = /* @__PURE__ */ __name((path2, options, callback) => {
      ...
      const walkSync = /* @__PURE__ */ __name((path3, currentLevel) => {
    ...
    var initialWalkAsync = /* @__PURE__ */ __name((path2, options, callback, doneCallback) => {
      if (options.maxLevelsDeep === void 0) {
        options.maxLevelsDeep = Infinity;
      }
      const performInspectOnEachNode = options.inspectOptions !== void 0;
      ...
      const checkConcurrentOperations = /* @__PURE__ */ __name(() => {
      ...
      const whenConcurrencySlotAvailable = /* @__PURE__ */ __name((operation) => {
        concurrentOperationsQueue.push(operation);
        checkConcurrentOperations();
      }, "whenConcurrencySlotAvailable");
      const concurrentOperationDone = /* @__PURE__ */ __name(() => {
        nowDoingConcurrentOperations -= 1;
        checkConcurrentOperations();
      }, "concurrentOperationDone");
      const walkAsync = /* @__PURE__ */ __name((path3, currentLevel) => {
        const goDeeperIfDir = /* @__PURE__ */ __name((fileItemPath, fileItem) => {
          if (fileItem.type === "dir" && currentLevel < options.maxLevelsDeep) {
...
var require_matcher = __commonJS({
  "node_modules/fs-jetpack/lib/utils/matcher.js"(exports2) {
    ...
    var convertPatternToAbsolutePath = /* @__PURE__ */ __name((basePath, pattern) => {
    ...
    exports2.create = (basePath, patterns, ignoreCase) => {
      ...
      const performMatch = /* @__PURE__ */ __name((absolutePath) => {
        let mode = "matching";
...
var require_find = __commonJS({
  "node_modules/fs-jetpack/lib/find.js"(exports2) {
    ...
    var processFoundPaths = /* @__PURE__ */ __name((foundPaths, cwd) => {
      return foundPaths.map((path2) => {
        return pathUtil.relative(cwd, path2);
      });
    }, "processFoundPaths");
    var generatePathDoesntExistError = /* @__PURE__ */ __name((path2) => {
      const err = new Error(`Path you want to find stuff in doesn't exist ${path2}`);
      err.code = "ENOENT";
      return err;
    }, "generatePathDoesntExistError");
    var generatePathNotDirectoryError = /* @__PURE__ */ __name((path2) => {
      const err = new Error(
        `Path you want to find stuff in must be a directory ${path2}`
      );
      err.code = "ENOTDIR";
      return err;
    }, "generatePathNotDirectoryError");
    var findSync = /* @__PURE__ */ __name((path2, options) => {
    ...
    var findSyncInit = /* @__PURE__ */ __name((path2, options) => {
    ...
    var findAsync = /* @__PURE__ */ __name((path2, options) => {
      return new Promise((resolve, reject) => {
        const foundAbsolutePaths = [];
        const matchesAnyOfGlobs = matcher.create(
          path2,
        ...
        const maybeDone = /* @__PURE__ */ __name(() => {
    ...
    var findAsyncInit = /* @__PURE__ */ __name((path2, options) => {
...
var require_inspect_tree = __commonJS({
  "node_modules/fs-jetpack/lib/inspect_tree.js"(exports2) {
    ...
    var relativePathInTree = /* @__PURE__ */ __name((parentInspectObj, inspectObj) => {
      if (parentInspectObj === void 0) {
        return ".";
      }
      return parentInspectObj.relativePath + "/" + inspectObj.name;
    }, "relativePathInTree");
    var checksumOfDir = /* @__PURE__ */ __name((inspectList, algo) => {
      const hash = crypto.createHash(algo);
    ...
    var calculateTreeDependentProperties = /* @__PURE__ */ __name((parentInspectObj, inspectObj, options) => {
    ...
    var findParentInTree = /* @__PURE__ */ __name((treeNode, pathChain, item) => {
    ...
    var inspectTreeSync = /* @__PURE__ */ __name((path2, opts) => {
      const options = opts || {};
      let tree;
    ...
    var inspectTreeAsync = /* @__PURE__ */ __name((path2, opts) => {
      const options = opts || {};
      let tree;
      return new Promise((resolve, reject) => {
        treeWalker.async(
...
var require_exists = __commonJS({
  "node_modules/fs-jetpack/lib/exists.js"(exports2) {
    ...
    var existsSync3 = /* @__PURE__ */ __name((path2) => {
      try {
    ...
    var existsAsync = /* @__PURE__ */ __name((path2) => {
      return new Promise((resolve, reject) => {
        fs2.stat(path2).then((stat) => {
          if (stat.isDirectory()) {
            resolve("dir");
...
var require_copy = __commonJS({
  "node_modules/fs-jetpack/lib/copy.js"(exports2) {
    ...
    var treeWalker = require_tree_walker();
    var validate = require_validate();
    var validateInput = /* @__PURE__ */ __name((methodName, from, to, options) => {
    ...
    var parseOptions = /* @__PURE__ */ __name((options, from) => {
      const opts = options || {};
      const parsedOptions = {};
      if (opts.ignoreCase === void 0) {
        opts.ignoreCase = false;
    ...
    var generateNoSourceError = /* @__PURE__ */ __name((path2) => {
      const err = new Error(`Path to copy doesn't exist ${path2}`);
      err.code = "ENOENT";
      return err;
    }, "generateNoSourceError");
    var generateDestinationExistsError = /* @__PURE__ */ __name((path2) => {
      const err = new Error(`Destination path already exists ${path2}`);
      err.code = "EEXIST";
      return err;
    }, "generateDestinationExistsError");
    var inspectOptions = {
      mode: true,
      symlinks: "report",
      times: true,
    ...
    var shouldThrowDestinationExistsError = /* @__PURE__ */ __name((context) => {
      return typeof context.opts.overwrite !== "function" && context.opts.overwrite !== true;
    }, "shouldThrowDestinationExistsError");
    var checksBeforeCopyingSync = /* @__PURE__ */ __name((from, to, opts) => {
      if (!exists.sync(from)) {
    ...
    var canOverwriteItSync = /* @__PURE__ */ __name((context) => {
    ...
    var copyFileSync = /* @__PURE__ */ __name((srcPath, destPath, mode, context) => {
    ...
    var copySymlinkSync = /* @__PURE__ */ __name((from, to) => {
    ...
    var copyItemSync = /* @__PURE__ */ __name((srcPath, srcInspectData, destPath, opts) => {
    ...
    var copySync = /* @__PURE__ */ __name((from, to, options) => {
    ...
    var checksBeforeCopyingAsync = /* @__PURE__ */ __name((from, to, opts) => {
    ...
    }, "checksBeforeCopyingAsync");
    var canOverwriteItAsync = /* @__PURE__ */ __name((context) => {
      return new Promise((resolve, reject) => {
        if (typeof context.opts.overwrite === "function") {
    ...
    var copyFileAsync = /* @__PURE__ */ __name((srcPath, destPath, mode, context, runOptions) => {
      return new Promise((resolve, reject) => {
    ...
    var copySymlinkAsync = /* @__PURE__ */ __name((from, to) => {
    ...
    var copyItemAsync = /* @__PURE__ */ __name((srcPath, srcInspectData, destPath, opts) => {
      const context = { srcPath, destPath, srcInspectData, opts };
      const mode = fileMode.normalizeFileMode(srcInspectData.mode);
      if (srcInspectData.type === "dir") {
    ...
    var copyAsync = /* @__PURE__ */ __name((from, to, options) => {
      return new Promise((resolve, reject) => {
        const opts = parseOptions(options, from);
...
var require_move = __commonJS({
  "node_modules/fs-jetpack/lib/move.js"(exports2) {
    ...
    var generateSourceDoesntExistError = /* @__PURE__ */ __name((path2) => {
      const err = new Error(`Path to move doesn't exist ${path2}`);
      err.code = "ENOENT";
      return err;
    }, "generateSourceDoesntExistError");
    var moveSync = /* @__PURE__ */ __name((from, to, options) => {
    ...
    var ensureDestinationPathExistsAsync = /* @__PURE__ */ __name((to) => {
      return new Promise((resolve, reject) => {
    ...
    var moveAsync = /* @__PURE__ */ __name((from, to, options) => {
      const opts = parseOptions(options);
      return new Promise((resolve, reject) => {
...
var require_read = __commonJS({
  "node_modules/fs-jetpack/lib/read.js"(exports2) {
    ...
    var validateInput = /* @__PURE__ */ __name((methodName, path2, returnAs) => {
    ...
    var jsonDateParser = /* @__PURE__ */ __name((key, value) => {
    ...
    var makeNicerJsonParsingError = /* @__PURE__ */ __name((path2, err) => {
      const nicerError = new Error(
        `JSON parsing failed while reading ${path2} [${err}]`
      );
      nicerError.originalError = err;
      return nicerError;
    }, "makeNicerJsonParsingError");
    var readSync = /* @__PURE__ */ __name((path2, returnAs) => {
    ...
    var readAsync = /* @__PURE__ */ __name((path2, returnAs) => {
      return new Promise((resolve, reject) => {
        const retAs = returnAs || "utf8";
        let encoding = "utf8";
        if (retAs === "buffer") {
...
var require_rename = __commonJS({
  "node_modules/fs-jetpack/lib/rename.js"(exports2) {
    ...
    var validate = require_validate();
    var validateInput = /* @__PURE__ */ __name((methodName, path2, newName, options) => {
    ...
    var renameSync = /* @__PURE__ */ __name((path2, newName, options) => {
      const newPath = pathUtil.join(pathUtil.dirname(path2), newName);
      move.sync(path2, newPath, options);
    }, "renameSync");
    var renameAsync = /* @__PURE__ */ __name((path2, newName, options) => {
      const newPath = pathUtil.join(pathUtil.dirname(path2), newName);
...
var require_symlink = __commonJS({
  "node_modules/fs-jetpack/lib/symlink.js"(exports2) {
    ...
    var validate = require_validate();
    var dir = require_dir();
    var validateInput = /* @__PURE__ */ __name((methodName, symlinkValue, path2) => {
      const methodSignature = `${methodName}(symlinkValue, path)`;
      validate.argument(methodSignature, "symlinkValue", symlinkValue, ["string"]);
      validate.argument(methodSignature, "path", path2, ["string"]);
    }, "validateInput");
    var symlinkSync = /* @__PURE__ */ __name((symlinkValue, path2) => {
      try {
    ...
    var symlinkAsync = /* @__PURE__ */ __name((symlinkValue, path2) => {
      return new Promise((resolve, reject) => {
...
var require_tmp_dir = __commonJS({
  "node_modules/fs-jetpack/lib/tmp_dir.js"(exports2) {
    ...
    var fs2 = require_fs2();
    var validate = require_validate();
    var validateInput = /* @__PURE__ */ __name((methodName, options) => {
    ...
    var getOptionsDefaults = /* @__PURE__ */ __name((passedOptions, cwdPath) => {
    ...
    var tmpDirSync = /* @__PURE__ */ __name((cwdPath, passedOptions) => {
    ...
    var tmpDirAsync = /* @__PURE__ */ __name((cwdPath, passedOptions) => {
      return new Promise((resolve, reject) => {
        const options = getOptionsDefaults(passedOptions, cwdPath);
...
var require_jetpack = __commonJS({
  "node_modules/fs-jetpack/lib/jetpack.js"(exports2, module2) {
    ...
    var write = require_write();
    var jetpackContext = /* @__PURE__ */ __name((cwdPath) => {
      const getCwdPath = /* @__PURE__ */ __name(() => {
        return cwdPath || process.cwd();
      }, "getCwdPath");
      const cwd = /* @__PURE__ */ __name(function() {
        if (arguments.length === 0) {
          return getCwdPath();
        }
      ...
      const resolvePath = /* @__PURE__ */ __name((path2) => {
        return pathUtil.resolve(getCwdPath(), path2);
      }, "resolvePath");
      const getPath = /* @__PURE__ */ __name(function() {
        Array.prototype.unshift.call(arguments, getCwdPath());
        return pathUtil.resolve.apply(null, arguments);
      }, "getPath");
      const normalizeOptions = /* @__PURE__ */ __name((options) => {
        const opts = options || {};
        opts.cwd = getCwdPath();
        return opts;
      }, "normalizeOptions");
      const api = {
        ...
        find: /* @__PURE__ */ __name((startPath, options) => {
        ...
        findAsync: /* @__PURE__ */ __name((startPath, options) => {
          if (typeof options === "undefined" && typeof startPath === "object") {
            options = startPath;
            startPath = ".";
          }
        ...
        tmpDirAsync: /* @__PURE__ */ __name((options) => {
        ...
        write: /* @__PURE__ */ __name((path2, data, options) => {
          write.validateInput("write", path2, data, options);
          write.sync(resolvePath(path2), data, options);
        }, "write"),
        writeAsync: /* @__PURE__ */ __name((path2, data, options) => {
...
var ASTRequestType = new import_coc.RequestType("textDocument/ast");
var ASTFeature = class {
  constructor(ctx) {
    this.ctx = ctx;
  }
  static {
    __name(this, "ASTFeature");
  }
  ...
  initialize(capabilities) {
    if ("astProvider" in capabilities && typeof import_coc.window["createTreeView"] === "function") {
      this.ctx.subscriptions.push(
        import_coc.commands.registerCommand("clangd.ast", async () => {
          if (!this.ctx.client) return;
          let range = null;
          const { document, position } = await import_coc.workspace.getCurrentState();
          const mode = await import_coc.workspace.nvim.call("visualmode");
          if (mode) range = await import_coc.window.getSelectedRange(mode);
          if (!range) range = import_coc.Range.create(position, position);
          const params = {
          ...
          if (!item) {
            import_coc.window.showInformationMessage("No AST node at selection");
            return;
          }
          const winid = await import_coc.workspace.nvim.eval("win_getid()");
          const adapter = new TreeAdapter();
          adapter.setRoot(item, import_coc.Uri.parse(document.uri), winid);
          const tree = import_coc.window.createTreeView("clangd.AST", {
...
var TreeAdapter = class {
  constructor() {
    this._onDidChangeTreeData = new import_coc.Emitter();
    this.onDidChangeTreeData = this._onDidChangeTreeData.event;
  }
  static {
    __name(this, "TreeAdapter");
  }
  hasRoot() {
  ...
  getTreeItem(node) {
    const item = new import_coc.TreeItem(describe(node.role, node.kind));
    if (node.children && node.children.length > 0) {
      item.collapsibleState = import_coc.TreeItemCollapsibleState.Expanded;
    }
  ...
  getParent(node) {
    if (node === this.root) return void 0;
...
((SymbolInfoRequest2) => {
  SymbolInfoRequest2.type = new import_coc2.RequestType("textDocument/symbolInfo");
...
function switchSourceHeader(ctx) {
  return async (openCommand) => {
    ...
    if (!dest) {
      import_coc2.window.showInformationMessage(`Didn't find a corresponding file.`);
      return;
    }
    await import_coc2.workspace.jumpTo(dest, null, openCommand);
  };
}
__name(switchSourceHeader, "switchSourceHeader");
function symbolInfo(ctx) {
  return async () => {
    ...
    const position = await import_coc2.window.getCursorPosition();
    const params = {
    ...
    import_coc2.window.showInformationMessage(`name: ${detail.name}, containerName: ${detail.containerName}, usr: ${detail.usr}`);
  };
}
...
__name(getUserConfigFile, "getUserConfigFile");
async function openConfigFile(p) {
  if (!fs.existsSync(p)) {
    await import_coc2.workspace.createFile(p);
  }
  await import_coc2.workspace.openResource(p);
}
__name(openConfigFile, "openConfigFile");
function userConfig() {
  const file = getUserConfigFile();
  if (file) {
    openConfigFile(file);
  } else {
    import_coc2.window.showWarningMessage("Couldn't get global configuration directory");
  }
}
__name(userConfig, "userConfig");
function projectConfig() {
  if (import_coc2.workspace.workspaceFolders.length > 0) {
    const folder = import_coc2.workspace.workspaceFolders[0];
    openConfigFile(path.join(import_coc2.Uri.parse(folder.uri).fsPath, ".clangd"));
  } else {
    import_coc2.window.showWarningMessage("No project is open");
  }
}
...
var Config = class {
  ...
  constructor() {
    this.cfg = import_coc3.workspace.getConfiguration("clangd");
  }
  get enabled() {
  ...
  get arguments() {
    return this.cfg.get("arguments", []).map((arg) => import_coc3.workspace.expand(arg));
  }
  get trace() {
    return this.cfg.get("trace", { file: "", server: "off" });
  }
  get fallbackFlags() {
    return this.cfg.get("fallbackFlags", []).map((flag) => import_coc3.workspace.expand(flag));
  }
...
var ClangdExtensionFeature = class {
  static {
    __name(this, "ClangdExtensionFeature");
  }
  dispose() {
  }
  initialize() {
...
var Ctx = class {
  ...
  isClangDocument(document) {
    return import_coc4.workspace.match(documentSelector, document);
  }
  async startServer(bin, ...features) {
    ...
    if (this.config.compilationDatabasePath) {
      initializationOptions.compilationDatabasePath = import_coc4.workspace.expand(this.config.compilationDatabasePath);
    ...
    const clientOptions = {
      ...
      middleware: {
        provideCompletionItem: /* @__PURE__ */ __name(async (document, position, context, token, next) => {
          ...
          for (const item of items) {
            if (item.score) item.score = Math.max(1, item.score) + item.score / 1e3;
        ...
        provideWorkspaceSymbols: /* @__PURE__ */ __name(async (query, token, next) => {
  ...
  closestCompilationDatabase(candidates) {
    const expandendCandidates = candidates.map((c) => import_coc4.workspace.expand(c));
    for (const candidate of expandendCandidates) {
      if ((0, import_node_fs.existsSync)((0, import_node_path.join)(candidate, "compile_commands.json"))) {
        return candidate;
      }
    }
    return "";
...
var UI = class {
  ...
  get clangdPath() {
    ...
    if (p === "") {
      try {
        const exes = (0, import_fs_jetpack.find)(this.storagePath, {
          matching: `**/${clangdExe}`,
          files: true,
          directories: false
        });
  ...
  set clangdPath(p) {
    this.config.update(
      "path",
      p.replace((0, import_node_os.homedir)(), "~"),
      /*isUser=*/
      true
    );
  }
...
var MemoryUsageRequest = new import_coc6.RequestType0("$/memoryUsage");
...
var MemoryUsageFeature = class {
  ...
  static {
    __name(this, "MemoryUsageFeature");
  }
  fillClientCapabilities() {
  }
  ...
  initialize(capabilities) {
    if ("memoryUsageProvider" in capabilities) {
      this.ctx.subscriptions.push(
        import_coc6.commands.registerCommand("clangd.memoryUsage", async () => {
          const usage = await this.ctx.client?.sendRequest(MemoryUsageRequest.method, {});
          results.length = 0;
          format(convert2(usage, "<root>"));
          import_coc6.window.echoLines(results);
        })
      );
    }
  }
...
async function activate2(context) {
  ...
  if (service) {
    import_coc7.window.showWarningMessage("Looks like you've configured clangd in coc-settings.json, you should remove it to use coc-clangd");
    return;
  }
  ...
  context.subscriptions.push(
    fileStatus,
    import_coc7.commands.registerCommand("clangd.switchSourceHeader", switchSourceHeader(ctx)),
    import_coc7.commands.registerCommand("clangd.symbolInfo", symbolInfo(ctx)),
    import_coc7.commands.registerCommand("clangd.userConfig", userConfig),
    import_coc7.commands.registerCommand("clangd.projectConfig", projectConfig),
